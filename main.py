...
try: app_id = int(os.environ.get("app_id", "25848289"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "88cf2c17c7a2bd21f4204c89c648dd40")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "6725769730:AAFlMmWseDDJW3WPlGtACR3klrAs_OeAm_k")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "⚡<b>File uploaded by [@RS_Movie](https://t.me/RS_Movie)</b>⚡\n`{file_name}`\n🔥  ↭ <b>Join Now [@RS_Movie](https://t.me/RS_Movie)</b> ↭  🔥")
...
about_message = """
<b>• Name : <a href=https://t.me/RS_Movie>RAS AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/RS_Movie>[RAS UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/RS_Movie>Click Here</a></b>
<b>• BACKUP CHANNEL : <a href=https://t.me/RS_Movie>Click Here</a></b>"""
...
print("Bot Created By https://t.me/RS_Movie")
